...
define gui.text_font = "LXGWBrightGB-Regular.ttf"

## Шрифт, используемый именами персонажей.
define gui.name_text_font = "LXGWBrightGB-Regular.ttf"

## Шрифт, используемый текстом вне игры.
define gui.interface_text_font = "LXGWBrightGB-Regular.ttf"

## Размер нормального текста диалога.
define gui.text_size = 32

## Размер имён персонажей.
define gui.name_text_size = 69
...
define gui.main_menu_background = Movie(play="images/main.webm")
...
define gui.button_text_selected_color = "ff0000"
...
## экрана.
define gui.navigation_xpos = 1599
